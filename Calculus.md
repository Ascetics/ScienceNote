...
&\xlongequal{\quad t=\sin x \quad} \int_0^1 \frac{2t}{1+t^4} \mathrm{d}t \\
&=\int_0^1 \frac{1}{1+t^4} \mathrm{d}t^2 \\
&\xlongequal{\quad u=t^2 \quad} \int_0^1 \frac{1}{1+u^2} \mathrm{d}u \\
