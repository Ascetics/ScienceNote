...
桌面文件扩展名为.2700，桌面有info.txt文件。综合分析特征包括：将文件后缀修改为 [sqlback@memeware.net].2700，并要求通过邮件 sqlback@memeware.net 联系。判断为Phobos家族。
...
任务1图片中扩展名前可以看见id[4A30C4F9-3524]。桌面的info.hta打开也可见ID。
